  ...
  return (
    <div className="bg-[#1a1a1a] text-white">
      ...
      <p className="text-white text-lg">October 2024</p>
          <h1 className="text-5xl text-blue-600 font-bold text-right leading-[0.9]">Blender <br />3D<br />Workshop</h1>
        </div>
      ...
      <section className="w-full bg-[#2a2626] pt-16">
        <h2 className="text-4xl font-extrabold text-blue-500 pb-4 text-center">Workshop Day 1</h2>
      ...
      <section className="w-full bg-[#1a1a1a] pt-16">
        <h2 className="text-4xl font-extrabold text-blue-500 pb-4 text-center">Workshop Day 2</h2>
            <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 py-16 px-8">
                  <InfoColumn
