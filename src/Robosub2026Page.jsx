...
const tagStyles = {
  ...
  Mechanical: 'border-blue-300/40 bg-blue-400/15 text-blue-100'
};
  ...
  return (
    <div className="min-h-screen bg-[#181818] text-white font-sans">
      <div className="flex flex-col pt-32 items-center text-center px-4">
        ...
        <h1 className="text-5xl sm:text-6xl font-bold text-blue-500 mb-8">RoboSub 2026</h1>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between gap-4 pb-0 px-8 md:px-20 bg-[#181818]">
        ...
        <div className="flex-1 text-center md:text-left">
          <h2 className="text-4xl sm:text-5xl font-bold text-blue-500 mb-4">
            {vehicle.title}
          </h2>
      ...
      <div className="flex flex-col gap-3 px-5 md:flex-row md:gap-5 justify-center -mt-2 md:-mt-8 pb-10">
        <Link
            to={vehicle.linkTo}
            className="inline-block bg-blue-600 hover:bg-[#d73a1a] text-white font-semibold px-8 py-2 rounded-lg shadow"
          >
            View {vehicle.label}
          </Link>
        <a
          ...
          className="inline-block bg-blue-600 hover:bg-[#d73a1a] text-white font-semibold px-8 py-2 rounded-lg shadow transition-all duration-200"
        >
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5 sm:p-6">
                  ...
                  <div className="mt-auto flex justify-center pt-6">
                    <Link
                      to={feature.subpage}
                      className="bg-[#d73a1a] hover:bg-blue-600 text-white font-semibold px-8 py-2 rounded-lg shadow transition-all duration-200"
                    >
                      View More
                    </Link>
                  </div>
      ...
      <section className="px-8 md:px-20 py-16 bg-[#1a1a1a]">
        <div className="flex flex-col items-center">
          <h2 className="text-4xl font-extrabold text-blue-500 mb-10">RoboSub 2026 Team Video</h2>
      ...
      <section className="relative overflow-hidden px-4 sm:px-8 md:px-20 py-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-4xl font-extrabold text-blue-500 mb-8">RoboSub 2026 Developmental Timeline</h2>
                  ...
                  >
                    <div className="mb-5 flex items-center justify-between gap-4">
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-blue-400 bg-blue-500 text-sm font-bold text-white">
                          {index + 1}
                        </div>
                        <p className="text-sm font-bold uppercase tracking-normal text-blue-200">
                          {item.phase}
                        </p>
                      </div>
                      <FaChevronDown
                        className={`text-sm text-blue-200 transition-transform duration-200 ${openTimelinePhase === index ? 'rotate-180' : ''}`}
                        aria-hidden="true"
                      />
                    </div>
