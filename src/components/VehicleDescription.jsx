    ...
    >
      ...
      <div className="flex-1 text-center lg:text-left sm:px-8">
        ...
        <div className="mt-4">
          <Link
            to={linkTo}
            className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-2.5 text-sm sm:text-base rounded-lg shadow-lg hover:shadow-blue-500/20 transition-all duration-200"
          >
            Meet {title.split(' ')[0]}
          </Link>
        </div>
