    ...
    <div className="min-h-screen bg-[#181818] text-white">
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-5xl sm:text-6xl font-bold text-blue-500 mb-8">Competitions</h1>
                ...
                <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg border border-gray-700">
                  ...
                  <div className="flex flex-col p-6 space-y-4">
                    ...
                    <Link
                      ...
                      className="bg-[#d73a1a] hover:bg-blue-600 text-white font-semibold px-8 py-2 rounded-lg shadow transition-all duration-200 inline-block w-max"
                    >
                      Learn More
                    </Link>
                  </div>
