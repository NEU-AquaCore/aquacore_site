    ...
    <div className="flex w-full flex-col gap-10">
      {subsections.map((subsection) => (
        <section key={subsection.title} className="grid grid-cols-1 gap-24 lg:grid-cols-[1fr_20rem] xl:grid-cols-[1fr_24rem] lg:items-center">
          <div>
            <h3 className="text-xl sm:text-2xl font-bold text-blue-200 mb-4">
              {subsection.title}
            </h3>
      ...
      <section className="px-4 sm:px-8 lg:px-20 pt-32 pb-16 bg-[#181818]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_0.85fr] gap-10 items-center">
          <div>
            ...
            <h1 className="text-4xl sm:text-6xl font-extrabold text-blue-500 mb-6">
              {subsystem.title}
            </h1>
          ...
          {contentSections.map((section) => (
            ...
            >
              {section.imageLayout === 'comparison' ? (
                ...
                <div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-blue-500 mb-8 text-center">
                    {section.title}
                  </h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-blue-500 mb-6 text-center">
                    {section.title}
                  </h2>
                  {section.description && (
