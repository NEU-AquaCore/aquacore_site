  ...
  return (
    <div className="min-h-screen bg-[#181818] text-white font-sans">
      <div className="flex flex-col md:flex-row pt-32 items-center md:justify-around text-center">
        ...
        <h1 className="text-5xl sm:text-6xl font-bold text-blue-500 mb-8">RoboSub 2025</h1>
      </div>
      ...
      <div className="flex pt-20 justify-center bg-[#303030] w-full">
        <h2 className="text-4xl font-extrabold text-blue-500 mb-8">Team Video</h2>
      </div>   
        ...
        <div className="relative flex flex-1 mt-12 md:mt-0 pb-10">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <p className="text-white text-center text-lg sm:text-xl px-4 pb-6 font-bold">
              Click here to view our team members behind AquaCore
            </p>
            <Link
              to="/team"
              className="bg-[#d73a1a] hover:bg-blue-600 text-white font-semibold px-8 py-2 rounded-lg shadow transition-all duration-200"
