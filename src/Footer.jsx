...
import { FaInstagram, FaLinkedinIn, FaGithub, FaEnvelope, FaWeibo } from 'react-icons/fa';
import { FaBilibili } from 'react-icons/fa6';
import aquacoreLogo from './assets/logos/aquacoreWheelLogo.png';

export default function Footer() {
  const [mailMenuOpen, setMailMenuOpen] = useState(false);
  const mailMenuRef = useRef(null);
  const email = 'neu_aquacore@163.com';
    ...
    <footer className="bg-[#222] text-gray-300 pt-10 pb-4 px-4">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="flex items-center justify-center mb-6">
          <img src={aquacoreLogo} alt="AquaCore Logo" className="h-14 w-auto object-contain" />
        </div>

        <p>
          A NEU student-led team specializing in underwater robotics with potential real-world applications
        </p>
        {/* Social Icons */}
        <div className="flex gap-6 mt-6 mb-6 items-center">
          ...
          <div className="relative" ref={mailMenuRef}>
            <button
              ...
              className="rounded-full border border-gray-500 p-2 hover:bg-blue-500 hover:text-white transition"
              aria-haspopup="menu"
