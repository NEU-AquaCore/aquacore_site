    ...
    <div className="min-h-screen bg-[#181818] text-white">
      ...
      <section className="relative w-full min-h-[60vh] flex flex-col justify-center items-center text-center px-4 sm:px-8 py-24 bg-black">
        <div className="relative z-10">
          <h1 className="text-5xl sm:text-6xl font-bold text-blue-500 mb-8">
            Research
          </h1>
          ...
          >
            ...
            <div className="relative h-64 bg-gray-700">
              ...
              {project.status === "ongoing" && (
                <div className="absolute top-4 right-4 bg-blue-500 text-black px-3 py-1 rounded-full text-sm font-medium">
                  Upcoming
                </div>
              )}
            ...
            <div className="p-6 flex flex-col space-y-4">
              ...
              <Link
                ...
                className="bg-[#d73a1a] hover:bg-blue-600 text-white font-semibold px-6 py-2 rounded-lg shadow transition-all duration-200 text-center"
              >
                Learn More
              </Link>
            </div>
