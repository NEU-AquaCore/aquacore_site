      ...
      >
        ...
        <section className="relative grid place-items-center h-[100vh]">
          <div ref={sceneRef} className="h-[100vh] w-[100vw] text-white z-0">
            <Canvas>
              <Scene progress={progress} modelType="challenge" />
            </Canvas>
          </div>
        </section>
        ...
        <section className="relative z-10 min-h-screen bg-[#171717] px-4 sm:px-8 lg:px-16 py-20 sm:py-24">
          ...
          <div className="mb-12 text-center">
              <h2 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-blue-500 mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {challengeSpecifications.map((spec) => (
              <div key={spec.title}>
          ...
          <Link
          to="/robosub2026"
          className="bg-[#d73a1a] hover:bg-blue-600 text-white font-semibold px-8 py-3 rounded-lg transition-all duration-200"
          >
