  ...
  function Carousel() {
    ...
    return (
      <div className="relative max-w-3xl h-[50vh] flex items-center justify-center">
        ...
        <button onClick={prev} className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-blue-500 text-black hover:text-white rounded-full p-2 shadow transition z-10">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" /></svg>
        </button>
        <button onClick={next} className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-blue-500 text-black hover:text-white rounded-full p-2 shadow transition z-10">
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex space-x-2">
          {images.map((_, i) => (
            <button
              key={i}
              onClick={() => setIdx(i)}
              className={`w-3 h-3 rounded-full ${i === idx ? 'bg-blue-500' : 'bg-white/60'} border border-white`}
            />
          ))}
        </div>
      </div>
  ...
  return(
    <div className="min-h-screen bg-[#181818] text-white font-sans">
      <div className="flex flex-col md:flex-row pt-32 items-center md:justify-around text-center">
        ...
        <h1 className="text-5xl sm:text-6xl font-bold text-blue-500 mb-8">Singapore AUV Challenge</h1>
      </div>
      ...
      <section className="flex flex-col justify-start items-center pt-10 pb-15 px-8 md:px-20 bg-[#303030]">
        <div className="flex flex-col justify-center items-center text-center space-y-8 max-w-4xl">
          <h2 className="text-4xl font-extrabold text-blue-500 mb-8">SAUVC Overview</h2>
      ...
      <section className="flex flex-col justify-start items-center pt-10 pb-15 px-8 md:px-20 bg-[#181818]">
        <div className="flex flex-col justify-center items-center text-center space-y-8 max-w-4xl">
          <h2 className="text-4xl font-extrabold text-blue-500 mb-8">2025 SAUVC Winners</h2>
        </div>
      ...
      <section className="flex flex-col justify-start items-center pt-10 pb-15 px-8 md:px-20 bg-[#303030]">
        <div className="flex flex-col justify-center items-center text-center space-y-8 max-w-4xl">
          <h2 className="text-4xl font-extrabold text-blue-500 mb-8">Changes Since 2024</h2>
          <p className="text-lg sm:text-xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 pt-20 pb-20 max-w-7xl w-full gap-10">
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-2xl sm:text-3xl font-extrabold text-blue-500 mb-6">Non-technical Changes</h3>
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-2xl sm:text-3xl font-extrabold text-blue-500 mb-6">Technical Changes</h3>
            <p className="text-lg sm:text-xl leading-relaxed mb-6">
      ...
      <section className="flex flex-col items-center pt-10 pb-10 px-8 bg-[#303030]">
        <h2 className="text-4xl font-extrabold text-blue-500 mb-8">Watch Mecatron at SAUVC!</h2>
