    ...
    <div className="min-h-screen bg-[#181818] text-white w-full overflow-x-hidden">
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-5xl font-bold text-blue-500 mb-8 text-center">Our Vehicles</h1>
      ...
      <div className="w-full">
        ...
        <VehicleDescription
          title="Clutch 2026"
          description="Clutch 2026 is our latest innovation, combining the best features. It is engineered to support high-performance dropper and gripper mechanisms, while maintaining a compact size."
          linkTo="/clutch"
          modelType="clutch"
