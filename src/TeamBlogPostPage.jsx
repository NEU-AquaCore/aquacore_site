...
function WeatherIcon({ weather }) {
  ...
  const iconClassName = 'text-base text-blue-200';
      ...
      {section.items.map((item) => {
        ...
        return (
          <div key={item.title} className="rounded-lg border border-white/10 bg-black/20">
            ...
            >
              <h3 className="text-base sm:text-lg font-bold text-blue-200">
                {item.title}
              </h3>
              <span className="shrink-0 text-sm text-blue-200" aria-hidden="true">
      ...
      <section className="px-4 sm:px-8 lg:px-20 pt-32 pb-16 bg-[#181818]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_0.85fr] gap-10 items-center">
          <div>
            <Link
              to="/blog"
              className="mb-8 inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow transition-all duration-200 hover:bg-[#d73a1a]"
            >
            ...
            <h1 className="text-3xl sm:text-5xl font-extrabold text-blue-500 mb-6">
              {post.title}
            </h1>
          ...
          {post.sections.map((section) => {
              ...
              return (
                ...
                >
                  <div className="mx-auto max-w-4xl">
                    <h2 className="text-center text-2xl sm:text-3xl font-bold text-blue-500 mb-6">
                      {section.heading}
                    </h2>
              ...
              return (
                ...
                >
                  <div className="mx-auto max-w-5xl">
                    <h2 className="text-center text-2xl sm:text-3xl font-bold text-blue-500 mb-3">
                      {section.heading}
                    </h2>
            ...
            if (section.layout === 'versionedRows') {
              return (
                ...
                >
                  <div className="mx-auto max-w-6xl">
                    <h2 className="text-center text-2xl sm:text-3xl font-bold text-blue-500 mb-8">
                      {section.heading}
                    </h2>
                      ...
                      {section.versions.map((version) => (
                        ...
                        >
                          <div className={!section.hideImages && version.images?.length > 1 ? 'mx-auto w-full max-w-4xl' : ''}>
                            <h3 className="text-xl sm:text-2xl font-bold text-blue-200">
                              {version.title}
                            </h3>
                            {version.subtitle && (
                              <p className="mt-1 text-sm sm:text-base font-semibold text-blue-100">
                                {version.subtitle}
                              </p>
                            )}
                    ...
                    <div className="flex items-center gap-3">
                      {hasMultipleDiaryEntries && (
                        <button
                          ...
                          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-blue-600 text-white transition-all duration-200 hover:bg-[#d73a1a] disabled:cursor-default disabled:bg-white/15 disabled:text-white/35"
                      ...
                      >
                        {section.entries.map((entry, index) => (
                          ...
                          <div>
                            ...
                            <h3 className="text-2xl sm:text-3xl font-bold text-blue-200">
                              {entry.shortTitle}
                            </h3>
                            <p className="mt-4 text-justify text-base sm:text-lg leading-relaxed text-gray-200">
                              {entry.body}
            ...
            if (section.layout === 'centeredImageBelow') {
              return (
                ...
                >
                  <div className="mx-auto max-w-5xl">
                    <h2 className="text-center text-2xl sm:text-3xl font-bold text-blue-500 mb-4">
                      {section.heading}
                    </h2>
                            ...
                            {subsection.collapsible ? (
                              ...
                              >
                                <div>
                                  ...
                                  {subsection.period && (
                                    <p className="mt-2 text-sm sm:text-base font-semibold text-blue-100">
                                      {subsection.period}
                                    </p>
                                  )}
                                </div>
                              ...
                              <>
                                <h3 className="text-xl sm:text-2xl font-bold text-blue-200 mb-3">
                                  {subsection.title}
                                </h3>
                                {subsection.period && (
                                  <p className="mb-3 text-sm sm:text-base font-semibold text-blue-100">
                                    {subsection.period}
                                  </p>
                                )}
                              </>
