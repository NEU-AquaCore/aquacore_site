...
const sponsorProfiles = {
  ...
  rse: {
    name: 'NEU Faculty of Robot Science and Engineering',
    logo: '/images/logos/neu_rse_logo.jpg',
    logoClass: 'max-h-56 max-w-full object-contain',
    bg: '#ffffff',
    text: 'text-black',
    imageClass: 'max-w-2xl object-contain',
    description: [
      'AquaCore is supported by NEU RSE.'
    ]
  },
  amsil: {
    name: 'Aerial and Maritime Swarm Intelligence Laboratory',
    logo: '/images/logos/neu_amsil_logo.png',
    logoClass: 'max-h-56 max-w-full object-contain',
    bg: '#ffffff',
    text: 'text-black',
    imageClass: 'max-w-2xl object-contain',
...
const supporterWriteup = [
  'AquaCore is based in the robotics labs at Faculty of Robot Science and Engineering, Northeastern University. We make full use of the lab space for team meetings and equipment such as 3D printers to build our underwater vehicles. We are grateful for the support from our school, and we strive to design robust AUVs capable of tackling complex underwater tasks in real-world scenarios.'
];
    ...
    <div className="min-h-screen bg-[#181818] text-white flex flex-col items-center">
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-5xl sm:text-6xl font-bold text-blue-500 mb-8">Sponsors and Supporters</h1>
          ...
          <div className={`grid grid-cols-1 items-center gap-10 ${yearData.tierImage ? 'lg:grid-cols-[0.9fr_1.1fr]' : ''}`}>
            <div className="text-left">
              <p className="text-justify text-white sm:text-xl leading-relaxed">
                Interested in sponsoring our team? AquaCore provides organizations with the opportunity to inspire and support the development of future engineers and connect with NEU students. If you're interested in sponsoring us, you may contact us within a click!
              </p>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:gap-5">
                {/* <a
                  ...
                  className="inline-block rounded-lg bg-blue-500 px-8 py-2 text-center font-semibold text-white shadow transition-all duration-200 hover:bg-blue-600"
                >
      ...
      <section className="w-full bg-[#1a1a1a] px-4 sm:px-8 py-16">
        <div className="max-w-screen-xl mx-auto">
          <div className="text-center mb-12">
            <h3 className="text-4xl sm:text-5xl font-bold text-blue-500">
              Supporters
            </h3>
          </div>
