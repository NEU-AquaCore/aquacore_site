  ...
  return (
    <div className="bg-[#1a1a1a] text-white">
      ...
      <p className="text-white text-lg">April 2025</p>
          <h1 className="text-5xl text-blue-600 font-bold text-right leading-[0.9]">Marine Vehicle<br />Workshop for WSS</h1>
        </div>
      ...
      <section className="w-full bg-[#2a2626]">
        <div className="max-w-screen-xl mx-auto px-8">
          <h2 className="text-4xl font-extrabold text-blue-500 pt-12 text-center">An Immersive Dive into Simulation</h2>
    ...
    <div className="w-full max-w-full md:max-w-xl aspect-video">
      ...
      <section className="w-full bg-[#1a1a1a] py-16">
        <div className="max-w-screen-xl mx-auto">
          <h2 className="text-4xl font-extrabold text-blue-500 mb-8 text-center">Igniting Curiosity and Future Innovation</h2>
          ...
          <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-center px-8 gap-8">
                ...
                {/* Text */}
                <div className="flex-1 flex flex-col justify-center items-start py-8">
                    <h3 className="text-4xl text-blue-500 mb-8 italic ">“I had no knowledge about marine tech before. It was such an eye-opening event.”</h3>
        ...
        {images.map((_, i) => (
          <button
            ...
            className={`w-3 h-3 rounded-full ${
              i === currentIndex ? 'bg-blue-500' : 'bg-white/50'
            } border border-white`}
          />
        ))}
      </div>
