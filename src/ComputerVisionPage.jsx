...
<div className="max-w-6xl mx-auto pt-12">
        <div className="flex items-start justify-between w-full">
          ...
          <h1 className="text-5xl text-blue-600 font-bold text-right leading-[0.9]">
      ...
      <section className="w-full bg-[#2a2626] pt-16">
        <h2 className="text-4xl font-extrabold text-blue-500 pb-4 text-center">Workshop Objectives</h2>
      ...
      <section className="w-full bg-[#1a1a1a] py-16">
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-center px-2 gap-8">
          {/* Left: Text */}
          <div className="flex-1 flex flex-col justify-center items-start py-8">
            <h2 className="text-4xl font-extrabold text-blue-500 mb-6">Live Demo</h2>
  ...
  return (
    <div className="flex flex-col items-center text-center space-y-4">
      ...
      <div className={`bg-white p-4 pb-10 shadow-md rounded-md transform ${rotate}`}>
        ...
        />
        {caption && (
          <p className="text-blue-500 mt-2 text-sm italic font-bold">{caption}</p>
        )}
      </div>

      {/* Heading + Subheading */}
      <h3 className="text-xl font-bold text-blue-500">{heading}</h3>
